...
```{r}
setwd("~/Documents/BIA 6301 Data Mining/Module 3/Data/")
...
NbClust(data=oil_price_df,diss = NULL, distance = "euclidean", method="complete", index="pseudot2")
```
